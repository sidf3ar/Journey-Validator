...
def validate_and_generate_all_corrections(data: dict, journey_suffix: str, replacements: list, triggers: list, league_club_code: str) -> tuple[list, pd.DataFrame, dict]:
    ...
    summary = {
        'suffix': {'passed': 0, 'total': 0},  # Renamed to 'suffix' for clarity
...
def process_upload_journey():
    ...
    suffix = request.form.get('suffix_for_report', 'Default_Journey_2024_V1')
    league_club_code = request.form.get('league_club_code_for_report', 'Default_League')
